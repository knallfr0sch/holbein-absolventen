...
final class VikBookingWidgetHorizontalSearch
{
	...
	public static function getMonWdayScript($format = 'long', $module_id = 0)
	{
		...
		return 'var vboMapWdays'.$module_id.' = ["'.self::applySubstr(JText::_('VBJQCALSUN'), $format).'", "'.self::applySubstr(JText::_('VBJQCALMON'), $format).'", "'.self::applySubstr(JText::_('VBJQCALTUE'), $format).'", "'.self::applySubstr(JText::_('VBJQCALWED'), $format).'", "'.self::applySubstr(JText::_('VBJQCALTHU'), $format).'", "'.self::applySubstr(JText::_('VBJQCALFRI'), $format).'", "'.self::applySubstr(JText::_('VBJQCALSAT'), $format).'"];
var vboMapMons'.$module_id.' = ["'.self::applySubstr(JText::_('VBMONTHONE'), $format).'","'.self::applySubstr(JText::_('VBMONTHTWO'), $format).'","'.self::applySubstr(JText::_('VBMONTHTHREE'), $format).'","'.self::applySubstr(JText::_('VBMONTHFOUR'), $format).'","'.self::applySubstr(JText::_('VBMONTHFIVE'), $format).'","'.self::applySubstr(JText::_('VBMONTHSIX'), $format).'","'.self::applySubstr(JText::_('VBMONTHSEVEN'), $format).'","'.self::applySubstr(JText::_('VBMONTHEIGHT'), $format).'","'.self::applySubstr(JText::_('VBMONTHNINE'), $format).'","'.self::applySubstr(JText::_('VBMONTHTEN'), $format).'","'.self::applySubstr(JText::_('VBMONTHELEVEN'), $format).'","'.self::applySubstr(JText::_('VBMONTHTWELVE'), $format).'"];';
	}
	...
	public static function parseFieldLabel($type, $field)
	{
		...
		if ($type == 'special_requests') {
			return JText::_('INQ_NOTES_SPREQUESTS');
		}
