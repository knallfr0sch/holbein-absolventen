...
<div class="loginregistercont">
	...
	<div class="loginregister-block registerblock">
		<form action="<?php echo JRoute::_('index.php?option=com_vikbooking'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post" name="vbreg" onsubmit="return checkVrcReg();">
			<h3><?php echo JText::_('VBREGSIGNUP'); ?></h3>
			<div class="loginregister-inner-block">
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbfname"><?php echo JText::_('VBREGNAME'); ?></span></div>
					<div class="loginregister-val"><input type="text" name="fname" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbflname"><?php echo JText::_('VBREGLNAME'); ?></span></div>
					<div class="loginregister-val"><input type="text" name="lname" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbfemail"><?php echo JText::_('VBREGEMAIL'); ?></span></div>
					<div class="loginregister-val"><input type="text" name="email" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbfusername"><?php echo JText::_('VBREGUNAME'); ?></span></div>
					<div class="loginregister-val"><input type="text" name="username" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbfpassword"><?php echo JText::_('VBREGPWD'); ?></span></div>
					<div class="loginregister-val"><input type="password" name="password" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><span id="vbfconfpassword"><?php echo JText::_('VBREGCONFIRMPWD'); ?></span></div>
				...
				<div class="loginregister-row loginregister-submit">
					<input type="submit" value="<?php echo JText::_('VBREGSIGNUPBTN'); ?>" class="btn booknow vbo-pref-color-btn" name="submit" />
				</div>
			</div>
		<?php
		foreach ($prices as $num => $pid) {
...
?>
	...
	<div class="loginregister-block loginblock">
		<form action="<?php echo $url; ?>" method="post">
			...
			<div class="loginregister-inner-block">
				<div class="loginregister-row">
					<div class="loginregister-lbl"><?php echo JText::_('VBREGUNAME'); ?></div>
					<div class="loginregister-val"><input type="text" name="log" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row">
					<div class="loginregister-lbl"><?php echo JText::_('VBREGPWD'); ?></div>
					<div class="loginregister-val"><input type="password" name="pwd" value="" size="20" class="vbinput"/></div>
				</div>
				<div class="loginregister-row loginregister-submit">
					<input type="submit" value="<?php echo JText::_('VBREGSIGNINBTN'); ?>" class="btn booknow vbo-pref-color-btn" name="Login" />
				</div>
			</div>
