...
<div class="vbo-operators-login-wrap">
	...
	<div class="vbo-operators-authcode">
		<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&task=operatorlogin&Itemid=' . $pitemid); ?>" method="post">
			<label for="authcode"><?php echo JText::_('VBOOPERAUTHCODE'); ?></label>
	...
	<div class="loginblock">
		<form action="<?php echo $url; ?>" method="post">
			...
			<div class="loginblock-cnt" valign="top">
				<div>
					<div class="loginblock-lbl"><label for="vbo-username"><?php echo JText::_('VBREGUNAME'); ?></label></div>
					<div class="loginblock-value"><input type="text" name="log" id="vbo-username" value="" size="20" class="vbinput"/></div>
				</div>
				<div>
					<div class="loginblock-lbl"><label for="vbo-password"><?php echo JText::_('VBREGPWD'); ?></label></div>
					<div class="loginblock-value"><input type="password" name="pwd" id="vbo-password" value="" size="20" class="vbinput"/></div>
				</div>
				<div>
					<div class="loginblock-subbtn"><input type="submit" value="<?php echo JText::_('VBREGSIGNINBTN'); ?>" class="btn booknow vbo-pref-color-btn" name="Login" /></div>
				</div>
			</div>
