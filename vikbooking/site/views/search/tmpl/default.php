...
<div class="vbstepsbarcont">
	<ol class="vbo-stepbar" data-vbosteps="4">
		<li class="vbo-step vbo-step-complete"><a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=vikbooking&checkin='.$this->checkin.'&checkout='.$this->checkout.'&category_id='.$pcategory_id.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBSTEPDATES'); ?></a></li>
		...
		<div class="vbo-results-chdates">
			<div class="vbo-results-head-det">
				<span class="vbo-results-head-det-val">
					<a href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=vikbooking&checkin='.$this->checkin.'&checkout='.$this->checkout.'&category_id='.$pcategory_id.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" class="vbo-pref-color-btn-secondary"><?php echo JText::_('VBCHANGEDATES'); ?></a>
				</span>
			</div>
		</div>
	</div>
...
<form action="<?php echo JRoute::_('index.php?option=com_vikbooking&view=vikbooking'.(!empty($pcategory_id) ? '&category_id=' . $pcategory_id : '').(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" method="post" id="vbselectroomform">
	...
	?>
	<div class="goback">
		<a class="vbo-goback-link vbo-pref-color-btn-secondary" href="<?php echo JRoute::_('index.php?option=com_vikbooking&view=vikbooking&checkin='.$this->checkin.'&checkout='.$this->checkout.'&category_id='.$pcategory_id.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VBCHANGEDATES'); ?></a>
	</div>
