	...
	<tr>
		...
		<td width="30%" align="right" valign="bottom">
			<table align="right" width="100%" style="border: 1px solid #22485d;" bgcolor="#fbfbfb" cellspacing="0" cellpadding="2">
				<tr>
					<td align="right"><strong><?php echo JText::_('VBOINVNUM'); ?> {invoice_number}</strong></td>
				</tr>
				<tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
	<tr bgcolor="#fbfbfb">
		<td rowspan="3" width="60%" valign="top"><strong><?php echo JText::_('VBOINVCOLCUSTINFO'); ?></strong><br/>{customer_info}</td>
		<td width="244" align="left"><strong><?php echo JText::_('VBOINVCOLTOTAL'); ?></strong> <?php echo $currencyname . ' ' . VikBooking::numberFormat($invoice['rawcont']['totalnet']); ?></td>
	</tr>
	<tr bgcolor="#fbfbfb">
		<td align="left"><strong><?php echo JText::_('VBOINVCOLTAX'); ?></strong> <?php echo $currencyname . ' ' . VikBooking::numberFormat($invoice['rawcont']['totaltax']); ?></td>
	</tr>
	<tr bgcolor="#fbfbfb">
		<td align="left" valign="bottom"><strong><u><?php echo JText::_('VBOINVCOLGRANDTOTAL'); ?></u></strong> <?php echo $currencyname . ' ' . VikBooking::numberFormat($invoice['rawcont']['totaltot']); ?></td>
	</tr>
</table>
