...
<div style="color: #444;">
		...
		<tr>
			...
			<td width="30%" align="right" valign="bottom">
				<table align="right" width="100%" style="border: 1px solid #22485d;" bgcolor="#fbfbfb" cellspacing="0" cellpadding="2">
					<tr>
						<td align="right"><?php echo JText::_('VBOINVNUM'); ?> <strong><span>{invoice_number}</span><span>{invoice_suffix}</span></strong></td>
					</tr>
					<tr>
						<td align="right"><?php echo JText::_('VBOINVDATE'); ?> <strong><span>{invoice_date}</span></strong></td>
					</tr>
				</table>
			</td>
		</tr>
	...
	<table width="100%" bgcolor="#fbfbfb" border="0" cellspacing="1" cellpadding="2">
		<tr bgcolor="#B2C1DF">
			<td width="40%"><strong><?php echo JText::_('VBO_INV_TAX_SUMMARY'); ?></strong></td>
			<td width="30%"><strong><?php echo JText::_('VBO_INV_TAX_ALIQUOTE'); ?></strong></td>
			<td width="30%"><strong><?php echo JText::_('VBOINVCOLTOTAL'); ?></strong></td>
		</tr>
		{invoice_tax_summary}
	</table>
	<br/>
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		<tr bgcolor="#fbfbfb">
			<td rowspan="3" valign="top"><strong><?php echo JText::_('VBOINVCOLCUSTINFO'); ?></strong><br/><br/><span>{customer_info}</span></td>
			<td rowspan="3" valign="top">
				<strong><?php echo JText::_('VBOINVCOLBOOKINGDETS'); ?></strong><br/><br/>
			...
			<td align="left"><strong><?php echo JText::_('VBOINVCOLTOTAL'); ?></strong> <span>{invoice_totalnet}</span></td>
		</tr>
		<tr bgcolor="#fbfbfb">
			<td align="left"><strong><?php echo JText::_('VBOINVCOLTAX'); ?></strong> <span>{invoice_totaltax}</span></td>
		</tr>
		<tr bgcolor="#fbfbfb">
			<td align="left" valign="bottom"><strong><u><?php echo JText::_('VBOINVCOLGRANDTOTAL'); ?></u></strong> <span>{invoice_grandtotal}</span></td>
		</tr>
	</table>
	<div>{inv_notes}</div>
</div>
