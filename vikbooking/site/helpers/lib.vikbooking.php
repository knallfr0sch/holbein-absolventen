		...
		foreach ($config as $value => $cont) {
			...
			switch ($cont['type']) {
				...
				case 'checkbox':
					...
					$html .= self::getVboApplication()->printYesNoButtons('vikcronparams['.$value.']', JText::_('VBYES'), JText::_('VBNO'), (isset($params[$value]) ? (int)$params[$value] : (int)$default_paramv), 1, 0);
					break;
				default:
