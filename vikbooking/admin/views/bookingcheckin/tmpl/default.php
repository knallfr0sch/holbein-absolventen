			...
			<div class="vbo-checkin-commands-btn">
				<button type="button" onclick="window.open('<?php echo VBO_SITE_URI.'helpers/checkins/generated/'.$customer['checkindoc']; ?>', '_blank');" class="btn btn-large btn-success"><i class="vboicn-download"></i> <?php echo JText::_('VBODWNLCHECKINDOC'); ?></button>
					...
					case -11:
						...
						?>
			<div class="vbo-checkin-commands-btn">
				<button type="button" onclick="if(confirm('<?php echo addslashes(JText::_('VBOBCOMREPORTNOSHOWCONF')); ?>')){window.open('<?php echo admin_url().'admin.php?option=com_vikchannelmanager&task=breporting.noShow&otaid='.$order['idorderota']; ?>', '_blank');}" class="btn btn-large btn-danger"><?php VikBookingIcons::e('ban'); ?> <?php echo JText::_('VBOBCOMREPORTNOSHOW'); ?></button>
			</div>
						<?php
						break;
					default:
