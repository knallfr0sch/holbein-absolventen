				...
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBNEWCUSTOMFCOUNTRY'); ?>*</div>
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBO_3CHAR_CODE'); ?></div>
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBO_2CHAR_CODE'); ?></div>
		...
		<div class="vbo-config-maintab-right">
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBPSHOWPAYMENTSFIVE'); ?></div>
							<div class="vbo-param-setting">
								<?php echo $vbo_app->printYesNoButtons('published', JText::_('VBYES'), JText::_('VBNO'), (!count($row) || $row['published'] == 1 ? 1 : 0), 1, 0); ?>
							</div>
						</div>
					</div>
				</div>
