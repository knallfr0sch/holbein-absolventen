		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				...
				<div class="vbo-param-container">
					...
					<div class="vbo-param-setting"><input type="text" name="currencysymb" value="<?php echo JHtml::_('esc_attr', VikBooking::getCurrencySymb(true)); ?>" size="10"/></div>
				</div>
				<div class="vbo-param-container">
		...
		<div class="vbo-params-wrap">
			...
			<div class="vbo-params-container">
				<div class="vbo-param-container">
					...
					<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('paytotal', JText::_('VBYES'), JText::_('VBNO'), (VikBooking::payTotal() ? 'yes' : 0), 'yes', 0); ?></div>
				</div>
				<div class="vbo-param-container">
