		...
		<div class="vbo-dashboard-firstsetup-body">
			<div class="vbo-dashboard-firstsetup-task vbo-dashboard-firstsetup-task-<?php echo $this->metrics['totprices'] < 1 ? 'incomplete' : 'completed'; ?>">
				<div class="vbo-dashboard-firstsetup-task-wrap">
					...
					<div class="vbo-dashboard-firstsetup-task-details">
						<div class="vbo-dashboard-firstsetup-task-name"><?php echo JText::_('VBDASHNOPRICES'); ?></div>
				...
				if ($this->metrics['totprices'] < 1) {
					...
					<div class="vbo-dashboard-firstsetup-task-action">
						<a href="index.php?option=com_vikbooking&task=prices" class="button button-secondary"><?php echo JText::_('VBCONFIGURETASK'); ?></a>
					</div>
					<?php
				}
				?>
					<div class="vbo-dashboard-firstsetup-task-description">
						<p><?php echo JText::_('VBOWIZARDRPLANSMESS'); ?></p>
					</div>
				</div>
			</div>
			<div class="vbo-dashboard-firstsetup-task vbo-dashboard-firstsetup-task-<?php echo $this->metrics['totrooms'] < 1 ? 'incomplete' : 'completed'; ?>">
				<div class="vbo-dashboard-firstsetup-task-wrap">
					...
					<div class="vbo-dashboard-firstsetup-task-details">
						<div class="vbo-dashboard-firstsetup-task-name"><?php echo JText::_('VBDASHNOROOMS'); ?></div>
						<div class="vbo-dashboard-firstsetup-task-count">
				...
				if ($this->metrics['totrooms'] < 1) {
					?>
					<div class="vbo-dashboard-firstsetup-task-action">
						<a href="index.php?option=com_vikbooking&task=rooms" class="button button-secondary"><?php echo JText::_('VBCONFIGURETASK'); ?></a>
					</div>
					<?php
				}
				?>
					<div class="vbo-dashboard-firstsetup-task-description">
						<p><?php echo JText::_('VBODASHFIRSTSETUPROOMS'); ?></p>
					</div>
				<?php
				/**
				...
				if ($this->metrics['totrooms'] > 0) {
					...
					<div class="vbo-dashboard-firstsetup-importbftpp">
						<h5 class="vbo-dashboard-firstsetup-importbftpp-title"><?php echo JText::_('VBO_IMPBFTPP_WANTTO'); ?></h5>
						<a class="btn btn-large btn-success" href="index.php?option=com_vikbooking&view=importbftpp"><?php VikBookingIcons::e('download'); ?> <?php echo JText::_('VBO_IMPBFTPP_DOIMPORT_SHORT'); ?></a>
					</div>
						<?php
					}
				}
			...
			<div class="vbo-dashboard-firstsetup-task vbo-dashboard-firstsetup-task-<?php echo $this->metrics['totdailyfares'] < 1 ? 'incomplete' : 'completed'; ?>">
				<div class="vbo-dashboard-firstsetup-task-wrap">
					...
					<div class="vbo-dashboard-firstsetup-task-details">
						<div class="vbo-dashboard-firstsetup-task-name"><?php echo JText::_('VBDASHNODAILYFARES'); ?></div>
						<div class="vbo-dashboard-firstsetup-task-count">
				...
				if ($this->metrics['totdailyfares'] < 1) {
					?>
					<div class="vbo-dashboard-firstsetup-task-action">
						<a href="index.php?option=com_vikbooking&task=tariffs" class="button button-secondary"><?php echo JText::_('VBCONFIGURETASK'); ?></a>
					</div>
					<?php
				}
				?>
					<div class="vbo-dashboard-firstsetup-task-description">
						<p><?php echo JText::_('VBODASHFIRSTSETUPTARIFFS'); ?></p>
					</div>
				</div>
			</div>
			<div class="vbo-dashboard-firstsetup-task vbo-dashboard-firstsetup-task-<?php echo !$this->metrics['shortcodes'] ? 'incomplete' : 'completed'; ?>">
				<div class="vbo-dashboard-firstsetup-task-wrap">
					...
					<div class="vbo-dashboard-firstsetup-task-details">
						<div class="vbo-dashboard-firstsetup-task-name"><?php echo JText::_('VBFIRSTSETSHORTCODES'); ?></div>
						<div class="vbo-dashboard-firstsetup-task-count">
				...
				if (!$this->metrics['shortcodes']) {
					?>
					<div class="vbo-dashboard-firstsetup-task-action">
						<a href="index.php?option=com_vikbooking&view=shortcodes" class="button button-secondary"><?php echo JText::_('VBCONFIGURETASK'); ?></a>
					</div>
					<?php
				}
				?>
					<div class="vbo-dashboard-firstsetup-task-description">
						<p><?php echo JText::_('VBODASHFIRSTSETUPSHORTCODES'); ?></p>
					</div>
				</div>
			</div>
		</div>
