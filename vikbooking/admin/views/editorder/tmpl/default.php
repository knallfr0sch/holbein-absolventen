					...
					<div class="vbo-modal-overlay-content-body">
						<div class="vbo-modal-guestmisconduct-addnew" data-bid="<?php echo $row['id']; ?>" data-otabid="<?php echo $row['idorderota']; ?>">
							...
							<div class="vbo-modal-guestmisconduct-addnew-save">
								...
								<button type="button" class="btn btn-danger" onclick="hideVboDialogGuestMisconduct();"><?php echo JText::_('VBOCLOSE'); ?></button>
							</div>
						</div>
					</div>
				</div>
					...
					if ($this->vcm_review) {
						...
						<div class="vbo-bookingdet-detcont-label vbo-bookingdet-detcont-label-review">
							<span class="label label-warning">
								<a href="index.php?option=com_vikchannelmanager&task=reviews&revid=<?php echo $this->vcm_review['id']; ?>" target="_blank" style="color: #fff;"><i class="vboicn-star-full"></i> <?php echo JText::_('VBOSEEGUESTREVIEW'); ?></a>
							</span>
						</div>
						<?php
						// check if a notification was clicked
				...
				?>
					<div class="vbo-bookingdet-detcont vbo-hidein-print">
						...
						<?php if (!empty($row['custmail'])) : ?>
							<div class="vbo-bookingdet-btncont">
								<button type="button" class="btn vbo-config-btn" onclick="vboToggleSendEmail();" style="vertical-align: top;"><?php VikBookingIcons::e('envelope'); ?> <?php echo JText::_('VBSENDEMAILACTION'); ?></button>
							</div>
						<?php endif; ?>
						</div>
					...
					<div class="vbo-bookingdet-detcont vbo-hidein-print">
						...
						<?php if (!empty($row['phone'])) : ?>
							<div class="vbo-bookingdet-btncont">
								<button type="button" class="btn vbo-config-btn" onclick="vboToggleSendSMS();" style="vertical-align: top;"><?php VikBookingIcons::e('comment-dots'); ?> <?php echo JText::_('VBSENDSMSACTION'); ?></button>
							</div>
						<?php endif; ?>
						</div>
			...
			<div class="vbo-bookingdet-innercontainer">
				...
				if (!$row['closure']) {
					...
					<div class="vbo-bookingdet-admin-entry">
						<label for="vbo-searchcust"><?php echo JText::_(count($customer) ? 'VBOASSIGNNEWCUST' : 'VBFILLCUSTFIELDS'); ?></label>
				...
				<div class="vbo-bookingdet-noteslogs">
					...
					<div class="vbo-bookingdet-noteslogs-btns">
						<div class="vbo-bookingdet-noteslogs-btn vbo-bookingdet-noteslogs-btn-active" data-id="notes">
							<a href="javascript: void(0);" id="vbo-trig-notes" onclick="javascript: vbToggleNotes(this);"><?php VikBookingIcons::e('user-lock'); ?> <?php echo JText::_('VBADMINNOTESTOGGLE'); ?></a>
						</div>
					<?php
					/**
					...
					if (!$printreceipt && !is_null($messaging)) {
						...
						<div class="vbo-bookingdet-noteslogs-btn" data-id="messaging">
							<a name="messaging" href="javascript: void(0);" id="vbo-trig-messaging" onclick="javascript: vbToggleMessaging(this);"><?php VikBookingIcons::e('comment-dots'); ?> <?php echo JText::_('VBO_GUEST_MESSAGING'); ?></a>
						</div>
						<?php
					}
					if (!empty($row['paymentlog'])) {
						...
						<div class="vbo-bookingdet-noteslogs-btn" data-id="paylogs">
							<a href="javascript: void(0);" id="vbo-trig-paylogs" onclick="javascript: vbToggleLog(this);"><?php VikBookingIcons::e('credit-card'); ?> <?php echo JText::_('VBPAYMENTLOGTOGGLE'); ?></a>
					...
					if (count($history)) {
						...
						<div class="vbo-bookingdet-noteslogs-btn" data-id="history">
							<a href="javascript: void(0);" id="vbo-trig-bookhistory" onclick="javascript: vbToggleHistory(this);"><?php VikBookingIcons::e('history'); ?> <?php echo JText::_('VBOBOOKHISTORYTAB'); ?></a>
						</div>
						<script type="text/javascript">
					...
					?>
						<div class="vbo-bookingdet-noteslogs-btn pro-feature" data-id="invnotes">
							<a href="javascript: void(0);" class="hasTooltip" id="vbo-trig-invnotes" onclick="javascript: vbToggleInvNotes(this);" title="<?php echo addslashes(JText::_('VBBOOKINGINVNOTESHELP')); ?>"><?php VikBookingIcons::e('file-invoice'); ?> <?php echo JText::_('VBBOOKINGINVNOTES'); ?></a>
						</div>
	...
	<div class="vbo-modal-overlay-content vbo-modal-overlay-content-large vbo-modal-overlay-content-sms-email">
		...
		<div class="vbo-modal-overlay-content-body vbo-modal-overlay-content-body-scroll">
			...
			<div id="vbo-overlay-sms-cont" style="display: none;">
				<h4 style="display: none;"><?php echo JText::_('VBSENDSMSACTION'); ?>: <span id="smstophone-lbl"><?php echo $row['phone']; ?></span></h4>
			...
			<div id="vbo-overlay-email-cont" style="display: none;">
				<h4 style="display: none;"><?php echo JText::_('VBSENDEMAILACTION'); ?>: <span id="emailto-lbl"><?php echo $row['custmail']; ?></span></h4>
