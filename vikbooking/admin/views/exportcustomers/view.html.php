...
class VikBookingViewExportcustomers extends JViewVikBooking {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VBMAINEXPCUSTOMERSTITLE'), 'vikbooking');
		JToolBarHelper::custom('exportcustomerslaunch', 'download', 'download', JText::_('VBOCSVEXPCUSTOMERSGET'), false);
