				...
				<div class="vbo-params-wrap">
					...
					<div class="vbo-params-container">
						...
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting"><?php echo $vbo_app->printYesNoButtons('cavail', JText::_('VBYES'), JText::_('VBNO'), ((count($row) && intval($row['avail']) == 1) || !count($row) ? 'yes' : 0), 'yes', 0); ?></div>
						</div>
						<div class="vbo-param-container">
		...
		<div class="vbo-config-maintab-right">
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					...
					?>
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBNEWROOMSMALLDESC'); ?></div>
						...
						<div class="vbo-param-container vbo-param-container-full">
							<div class="vbo-param-label"><?php echo JText::_('VBNEWROOMSEVEN'); ?></div>
							<div class="vbo-param-setting">
								<?php
