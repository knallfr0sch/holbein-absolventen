		...
		<div class="vbo-config-maintab-left">
			<fieldset class="adminform">
				<div class="vbo-params-wrap">
					<legend class="adminlegend"><?php echo JText::_('VBO_REFUND'); ?></legend>
					<div class="vbo-params-container">
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBO_REFUND_AMOUNT'); ?></div>
							<div class="vbo-param-setting">
								<?php
						...
						<div class="vbo-param-container">
							<div class="vbo-param-label"><?php echo JText::_('VBO_REFUND_REASON'); ?></div>
							<div class="vbo-param-setting">
						...
						<div class="vbo-param-container">
							...
							<div class="vbo-param-setting">
								<button type="submit" class="btn btn-large btn-danger" onclick="return vboValidateDoRefund();"><?php VikBookingIcons::e('credit-card'); ?> <?php echo JText::_('VBO_REFUND'); ?></button>
							</div>
						</div>
					<?php
					...
					foreach ($this->refunds as $prev_refund_event) {
						...
						<div class="vbo-param-container vbo-param-container-log">
							 ...
							 */
							echo JHtml::_('date', $prev_refund_event['dt']);
							?>
							</div>
							<div class="vbo-param-setting">
...
<script type="text/javascript">
	function vboValidateDoRefund() {
		...
		if (!amount.length || isNaN(amount) || amount <= 0) {
			alert("<?php echo addslashes(JText::_('VBO_PLEASE_FILL_FIELDS')); ?>");
			return false;
		}
		return confirm("<?php echo addslashes(JText::_('VBO_DOREFUND_CONFIRM')); ?>");
	}
<?php
if ($success > 0) {
	?>
