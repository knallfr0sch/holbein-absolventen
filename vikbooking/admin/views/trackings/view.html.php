...
class VikBookingViewTrackings extends JViewVikBooking {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::_('VBMAINTRACKINGSTITLE'), 'vikbooking');
		if (JFactory::getUser()->authorise('core.delete', 'com_vikbooking')) {
			JToolBarHelper::deleteList(JText::_('VBDELCONFIRM'), 'removetrackings', JText::_('VBMAINCRONDEL'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikbooking')) {
			JToolBarHelper::custom('modtracking', 'refresh', 'refresh', JText::_('VBTRKTGLPUBLISHED'), true, false);
			JToolBarHelper::spacer();
		}
