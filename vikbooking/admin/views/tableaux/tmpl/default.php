	...
	<form name="adminForm" action="index.php?option=com_vikbooking&task=tableaux" method="post" id="adminForm">
		...
		<div id="filter-bar" class="btn-toolbar vbo-btn-toolbar vbo-tableaux-filters" style="width: 100%; display: inline-block;">
			...
			<div class="btn-group pull-right">
				<a href="javascript: void(0);" onclick="vboManagePermissions();" class="vbo-perms-operators"><i class="vboicn-user-plus icn-nomargin"></i> <span><?php echo JText::_('VBOPERMSOPERATORS'); ?></span></a>
			</div>
			<div class="btn-group pull-right">
...
<div class="vbo-modal-overlay-block vbo-modal-overlay-block-tableauxperms">
	...
	<div class="vbo-modal-overlay-content vbo-modal-overlay-content-large vbo-modal-overlay-content-tableauxperms">
		<div class="vbo-modal-overlay-content-head vbo-modal-overlay-content-head-dashwidgets">
			<h3><span><?php echo $vbo_app->createPopover(array('title' => JText::_('VBOPERMSOPERATORS'), 'content' => JText::_('VBOPERMSOPERATORSSHELP'))); ?> <?php echo JText::_('VBOPERMSOPERATORS'); ?></span> <span class="vbo-modal-overlay-close-times" onclick="hideVboDialog();">&times;</span></h3>
		</div>
			...
			<div class="vbo-tableauxperms-info-list">
				...
				foreach ($currentops as $op) {
					...
					<div class="vbo-pmsperm-entry-wrap">
						...
						<div class="vbo-pmsperm-entry-cont">
							<div class="vbo-pmsperm-entry-lbl">
								<?php echo JText::_('VBOPERMTBLXDAYS'); ?>
							</div>
							<div class="vbo-pmsperm-entry-val">
						...
						<div class="vbo-pmsperm-entry-cont">
							<div class="vbo-pmsperm-entry-lbl">
								<?php echo JText::_('VBOPERMTBLXROOMS'); ?>
							</div>
							<div class="vbo-pmsperm-entry-val">
						...
						<div class="vbo-pmsperm-entry-cont">
							<div class="vbo-pmsperm-entry-lbl">
								<?php echo JText::_('VBOCUSTOMERDETAILS'); ?>
							</div>
							<div class="vbo-pmsperm-entry-val">
								<select name="oper_guestname[<?php echo $opindex; ?>]">
									<option value="1"<?php echo !empty($op['perms']['guestname']) ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBYES'); ?></option>
									<option value="0"<?php echo empty($op['perms']['guestname']) ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBNO'); ?></option>
								</select>
							</div>
						</div>
						<div class="vbo-pmsperm-entry-cont">
							...
							<div class="vbo-pmsperm-entry-val">
								<select name="oper_roomextras[<?php echo $opindex; ?>]">
									<option value="1"<?php echo !empty($op['perms']['roomextras']) ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBYES'); ?></option>
									<option value="0"<?php echo empty($op['perms']['roomextras']) ? ' selected="selected"' : ''; ?>><?php echo JText::_('VBNO'); ?></option>
								</select>
							</div>
						</div>
						<div class="vbo-pmsperm-entry-cont">
		...
		<div class="vbo-modal-overlay-content-footer">
			<div class="vbo-modal-overlay-content-footer-left">
				<button type="button" class="btn btn-secondary" onclick="javascript: vboAddPermission();"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBOADDOPERATORPERM'); ?></button>
			</div>
			<div class="vbo-modal-overlay-content-footer-right">
				<button type="button" class="btn btn-success btn-large" onclick="document.getElementById('vbo-tblx-fperms').submit();"><?php echo JText::_('VBAPPLY'); ?></button>
				<button type="button" class="btn btn-danger btn-large" onclick="javascript: hideVboDialog();"><?php echo JText::_('VBANNULLA'); ?></button>
			</div>
		</div>
	</div>
</div>
...
function vboAddPermission() {
	...
	newperm += '		<div class="vbo-pmsperm-entry-lbl"><?php echo addslashes(JText::_('VBOOPERATOR')); ?></div>';
	newperm += '		<div class="vbo-pmsperm-entry-val">'+operatoridsel.replace(/%s/g, opindex)+'</div>';
	newperm += '	</div>';
	newperm += '	<div class="vbo-pmsperm-entry-cont">';
	newperm += '		<div class="vbo-pmsperm-entry-lbl"><?php echo addslashes(JText::_('VBOPERMTBLXDAYS')); ?></div>';
	newperm += '		<div class="vbo-pmsperm-entry-val"><input type="number" name="oper_days['+opindex+']" value="14" min="1" /></div>';
	newperm += '	</div>';
	newperm += '	<div class="vbo-pmsperm-entry-cont">';
	newperm += '		<div class="vbo-pmsperm-entry-lbl"><?php echo addslashes(JText::_('VBOPERMTBLXROOMS')); ?></div>';
	newperm += '		<div class="vbo-pmsperm-entry-val">'+operatorroomsel.replace(/%s/g, opindex)+'</div>';
	newperm += '	</div>';
	newperm += '	<div class="vbo-pmsperm-entry-cont">';
	newperm += '		<div class="vbo-pmsperm-entry-lbl"><?php echo addslashes(JText::_('VBOCUSTOMERDETAILS')); ?></div>';
	newperm += '		<div class="vbo-pmsperm-entry-val">';
	newperm += '			<select name="oper_guestname['+opindex+']">';
	newperm += '				<option value="1" selected="selected"><?php echo JText::_('VBYES'); ?></option>';
	newperm += '				<option value="0"><?php echo JText::_('VBNO'); ?></option>';
	newperm += '			</select>';
	newperm += '		</div>';
	newperm += '	</div>';
	newperm += '	<div class="vbo-pmsperm-entry-cont">';
	newperm += '		<div class="vbo-pmsperm-entry-lbl"><?php echo addslashes(JText::_('VBPEDITBUSYEXTRACOSTS')); ?></div>';
	newperm += '		<div class="vbo-pmsperm-entry-val">';
	newperm += '			<select name="oper_roomextras['+opindex+']">';
	newperm += '				<option value="1"><?php echo JText::_('VBYES'); ?></option>';
	newperm += '				<option value="0"><?php echo JText::_('VBNO'); ?></option>';
	newperm += '			</select>';
	newperm += '		</div>';
	newperm += '	</div>';
	...
	jQuery(".vbo-perm-roomsel-js-"+opindex).select2({placeholder: '<?php echo addslashes(JText::_('VBCOUPONALLVEHICLES')); ?>', width: "200px", allowClear: true});
...
jQuery(document).ready(function() {
	...
	jQuery("#roomsel, .vbo-perm-roomsel").select2({placeholder: '<?php echo addslashes(JText::_('VBCOUPONALLVEHICLES')); ?>', width: "300px", allowClear: true});
