...
class VikBookingViewStates extends JViewVikBooking
{
	...
	{
		JToolBarHelper::title(JText::_('VBMAINSTATESTITLE'), 'vikbooking');
		if (JFactory::getUser()->authorise('core.create', 'com_vikbooking')) {
			JToolBarHelper::addNew('states.add', JText::_('VBMAINPAYMENTSNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikbooking')) {
			JToolBarHelper::editList('states.edit', JText::_('VBMAINPAYMENTSEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikbooking')) {
			JToolBarHelper::deleteList(JText::_('VBDELCONFIRM'), 'states.remove', JText::_('VBMAINPAYMENTSDEL'));
			JToolBarHelper::spacer();
		}
	}
}
