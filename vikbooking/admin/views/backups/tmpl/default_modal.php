	...
	<div class="vbo-admin-container vbo-params-container-wide">
		...
		<div class="vbo-params-container">
			...
			<div class="vbo-param-container">
				<div class="vbo-param-label"><?php echo JText::_('VBO_BACKUP_ACTION_LABEL'); ?> <sup>*</sup></div>
				<div class="vbo-param-setting">
					<select name="action" id="vbo-create-action-sel">
						<?php
						$options = [
							JHtml::_('select.option', 'create', JText::_('VBO_BACKUP_ACTION_CREATE')),
							JHtml::_('select.option', 'upload', JText::_('VBO_BACKUP_ACTION_UPLOAD')),
						];
			...
			<div class="vbo-param-container backup-action-create">
				<div class="vbo-param-label"><?php echo JText::_('VBO_CONFIG_BACKUP_TYPE'); ?> <sup>*</sup></div>
				<div class="vbo-param-setting">
					<select name="type" id="vbo-create-type-sel">
						...
						echo JHtml::_('select.options', $options, 'value', 'text', VBOFactory::getConfig()->get('backuptype'));
						?>
					</select>
				</div>
			</div>
