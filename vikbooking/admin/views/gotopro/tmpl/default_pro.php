	...
	<div class="viwpro-procnt-inner">
		<div class="vikwppro-header">
			<div class="vikwppro-header-inner">
				<div class="vikwppro-header-text">
					<h2><?php echo JText::_('VBOPROTHANKSUSE'); ?></h2>
					<h3><?php echo JText::_('VBOPROTHANKSLIC'); ?></h3>
				</div>
			</div>
		</div>
		<div class="vikwppro-licencecnt">
			<div class="col col-md-6 col-sm-12 vikwppro-licencetext">
				<div>
					<h3><?php echo VikBookingLicense::hasVcm() ? JText::_('VBOLICKEYVALIDVCM') : JText::sprintf('VBOLICKEYVALIDUNTIL', $valid_until); ?></h3>
					<h4><?php echo JText::_('VBOPROGETRENEWLICFROM'); ?></h4>
					<a href="https://vikwp.com/plugin/vikbooking?utm_source=free_version&utm_medium=vbo&utm_campaign=renewlicence" class="vikwp-btn-link" target="_blank"><?php VikBookingIcons::e('rocket'); ?> <?php echo JText::_('VBOPROGETRENEWLIC'); ?></a>
				</div>
				...
				<form>				
					<div class="vikwppro-licenceform-inner">
						...
						<div>
							...
							<button type="button" class="btn btn-primary" id="vikwpvalidate" onclick="vikWpValidateLicenseKey();"><?php echo JText::_('VBOPROVALNUPD'); ?></button>
						</div>
					</div>
				</form>
			</div>
	...
	<div class="viwpro-e4jc">
		<div class="viwpro-e4jc-inner">
			<div class="viwpro-e4jc-text">
				<h3><?php echo JText::_('VBOPROVCMADTITLE'); ?></h3>
				<p><?php echo JText::_('VBOPROVCMADDESCR'); ?></p>
				<a href="https://vikwp.com" class="btn btn-primary" target="_blank"><?php echo JText::_('VBOPROVCMADMOREINFO'); ?></a>
			</div>
		...
		<div class="viwpro-e4jc-noshow"><a href="admin.php?option=com_vikbooking&view=gotopro&hidead=1" class="btn"><?php echo JText::_('VBOPROVCMADDONTSHOW'); ?></a></div>
	</div>
<?php
}
?>
