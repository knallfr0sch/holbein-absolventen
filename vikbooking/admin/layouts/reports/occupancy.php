...
if ($cookie_step == 'month') {
	...
	$period_name = JText::_('VBONEXTWEEKND');
}
...
<div class="vbo-reportwidget-outer vbo-reportwidget-occupancy vbo-reportwidget-<?php echo $vbo_page; ?>">
	...
	<div class="vbo-reportwidget-filters">
		...
		<div class="vbo-reportwidget-filter vbo-reportwidget-filter-confirm">
			<button type="button" class="btn vbo-config-btn" id="vbo-reportwidget-update"><?php echo JText::_('VBADMINNOTESUPD'); ?></button>
		</div>
	</div>
...
function vboReportWidgetSuggestPromotion(response) {
	...
	promo_content += '<div class="vbo-reportwidget-promo-icon"><span onclick="vboReportWidgetShowPromotion();" title="<?php echo addslashes(JText::_('VBOINSIGHT')); ?>"><?php VikBookingIcons::e('lightbulb'); ?></span></div>';
	...
	promo_content += '<h5><?php echo addslashes(JText::_('VBOINSIGHT')); ?></h5><p class="vbo-promo-tip-title">' + vboPromoInsightTitle + '</p><p class="vbo-promo-tip-help">' + vboPromoInsightHelp + '</p>';
	promo_content += '<div class="vbo-reportwidget-promo-link">';
	promo_content += '<a href="' + promo_uri + '" class="btn vbo-config-btn" target="_blank"><?php VikBookingIcons::e('rocket'); ?> <?php echo addslashes(JText::_('VBOSUGGCREATEPROMOOCC')); ?></a>';
	promo_content += '</div>';
	promo_content += '</div>';
	promo_content += '</div>';
	promo_content += '</div>';
