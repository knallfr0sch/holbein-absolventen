...
class VikBookingConditionalRuleNumberOfNights extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBOINVTOTNIGHTS');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_NON_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBDAYSFROM'); ?></div>
			<div class="vbo-param-setting">
				<input type="number" name="<?php echo $this->inputName('from_nights'); ?>" value="<?php echo $this->getParam('from_nights', ''); ?>" min="1" />
			</div>
		</div>
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBDAYSTO'); ?></div>
			<div class="vbo-param-setting">
