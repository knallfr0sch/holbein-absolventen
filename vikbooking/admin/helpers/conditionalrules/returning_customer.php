...
class VikBookingConditionalRuleReturningCustomer extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_CONDTEXT_RULE_RETCUST');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_RETCUST_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_CONDTEXT_RULE_RETCUST'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('returning'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('returning', 0), 1, 0); ?>
			</div>
		</div>
		<?php
	}
