...
class VikBookingConditionalRulePaymentStatus extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_HISTORY_GPM');
	...
	{
		return [
			'fully_paid' 	   => JText::_('VBOCOLORTAGRULECONFFIVE'),
			'partially_paid'   => JText::_('VBOCOLORTAGRULECONFFOUR'),
			'payment_received' => JText::_('VBOBOOKHISTORYTP0'),
			'to_be_paid' 	   => JText::_('VBOCOLORTAGRULECONFTHREE'),
		];
	}
}
