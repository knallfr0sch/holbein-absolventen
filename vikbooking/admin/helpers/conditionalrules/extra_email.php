...
class VikBookingConditionalRuleExtraEmail extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_CONDTEXT_RULE_EXTRAMAIL');
		$this->ruleDescr = JText::_('VBO_CONDTEXT_RULE_EXTRAMAIL_DESCR');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBCUSTOMEREMAIL'); ?></div>
			<div class="vbo-param-setting">
				<input type="text" name="<?php echo $this->inputName('extra_email'); ?>" value="<?php echo $this->getParam('extra_email', ''); ?>" />
				<span class="vbo-param-setting-comment"><?php echo JText::_('VBO_CONDTEXT_RULE_SEPEMAIL'); ?></span>
			</div>
		</div>
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_CONDTEXT_RULE_BCCEMAIL'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('bcc'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('bcc', 0), 1, 0); ?>
			</div>
		</div>
		<?php
	}
