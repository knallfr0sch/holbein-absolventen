...
class VikBookingConditionalRuleSplitStay extends VikBookingConditionalRule
{
	...
	public function __construct()
	{
		...
		$this->ruleName = JText::_('VBO_SPLIT_STAYS');
		$this->ruleDescr = JText::_('VBO_BOOK_SPLIT_STAYS');
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			<div class="vbo-param-label"><?php echo JText::_('VBO_SPLIT_STAY'); ?></div>
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('is_split_stay'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('is_split_stay', 0), 1, 0); ?>
			</div>
		</div>
		<?php
	}
