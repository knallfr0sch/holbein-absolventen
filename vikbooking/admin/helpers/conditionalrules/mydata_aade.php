...
class VikBookingConditionalRuleMydataAade extends VikBookingConditionalRule
{
	...
	public function renderParams()
	{
		...
		<div class="vbo-param-container">
			...
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('qr_code'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('qr_code', 0), 1, 0); ?>
		...
		<div class="vbo-param-container">
			...
			<div class="vbo-param-setting">
				<?php echo $this->vbo_app->printYesNoButtons($this->inputName('invoice_mark'), JText::_('VBYES'), JText::_('VBNO'), (int)$this->getParam('invoice_mark', 0), 1, 0); ?>
