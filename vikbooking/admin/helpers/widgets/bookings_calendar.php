				...
				<div class="vbo-widget-booskcal-inner">
					...
					<div class="vbo-widget-booskcal-top-wrap">
						...
						<div class="vbo-widget-booskcal-newbook">
							<button type="button" class="btn btn-success vbo-widget-booskcal-newbook-start" onclick="vboWidgetBookCalsNewBooking('<?php echo $wrapper_id; ?>');"><?php VikBookingIcons::e('plus-circle'); ?> <?php echo JText::_('VBO_NEW_BOOKING'); ?></button>
