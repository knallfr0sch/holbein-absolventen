	...
	<div class="btn-toolbar hidden-phone" id="vbo-search-tools">
		...
		<div class="btn-group pull-left">
			<select name="client" id="vbo-client-sel" class="active" onchange="document.adminForm.submit();">
				<?php
				$options = [
					JHtml::_('select.option',          'site', __('Site Pages', 'vikbooking')),
					JHtml::_('select.option', 'administrator', __('Admin Pages', 'vikbooking')),
					JHtml::_('select.option',       'widgets', __('Widgets', 'vikbooking')),
					JHtml::_('select.option',       'layouts', __('Layouts', 'vikbooking')),
				];
		...
		<div class="btn-group pull-left">
			<select name="status" id="vbo-status-sel" class="<?php echo $this->filters['status'] !== '' ? 'active' : ''; ?>" onchange="document.adminForm.submit();">
				<?php
				$options = [
					JHtml::_('select.option', '', __('- Select Status -', 'vikbooking')),
					JHtml::_('select.option',  1, __('Active', 'vikbooking')),
					JHtml::_('select.option',  0, __('Inactive', 'vikbooking')),
				];
